...
import CvFoldOut from "./CvFoldOutMobile";
...
const Introduction = ({
  ...
  return (
    <>
      <header className="p-[--container-p-mobile]">
        <section className="flex flex-col pb-[--gap-small]">
          <div className="flex justify-center pb-[--gap-small]">
            <Image
